...
func init() {
	//
	// Tri-state environment variable QOIN_CHAIN_BADGERSTORE_DISABLE_FSYNC
	...
	//
	if nosyncBs, nosyncBsSet := os.LookupEnv("QOIN_CHAIN_BADGERSTORE_DISABLE_FSYNC"); nosyncBsSet {
