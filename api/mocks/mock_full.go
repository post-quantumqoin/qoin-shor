...
// Source: github.com/post-quantumqoin/qoin-shor/api (interfaces: FullNode)
...
import (
	...
	miner "github.com/post-quantumqoin/core-types/builtin/v9/miner"
	...
	miner0 "github.com/post-quantumqoin/qoin-shor/core/contracts/builtin/miner"
	types "github.com/post-quantumqoin/qoin-shor/core/types"
	ethtypes "github.com/post-quantumqoin/qoin-shor/core/types/ethtypes"
	alerting "github.com/post-quantumqoin/qoin-shor/journal/alerting"
	dtypes "github.com/post-quantumqoin/qoin-shor/node/modules/dtypes"
	imports "github.com/post-quantumqoin/qoin-shor/node/repo/imports"
)
...
func (m *MockFullNode) EthGetCode(arg0 context.Context, arg1 string, arg2 ethtypes.EthBlockNumberOrHash) (ethtypes.EthBytes, error) {
	m.ctrl.T.Helper()
