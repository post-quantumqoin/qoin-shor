...
type Gateway interface {
	...
	EthGetTransactionReceipt(ctx context.Context, c cid.Cid) (*EthTxReceipt, error)
	EthGetTransactionReceiptLimited(ctx context.Context, txHash cid.Cid, limit abi.ChainEpoch) (*EthTxReceipt, error)
