//go:build quantumresistnet
// +build quantumresistnet
...
var NetworkBundle = "quantumresistnet"
var BundleOverrides map[actorstypes.Version]string
var ActorDebugging = false

const BootstrappersFile = "quantumresistnet.pi"
const GenesisFile = "quantumresistnet.car"
...
func init() {
	...
	fmt.Println("quantumresistnet.go SetAddressNetwork:%s\n", address.Testnet)
	Devnet = true
