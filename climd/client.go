...
dataCid comes from running 'shor client import'.
miner is the address of the miner you wish to make a deal with.
price is measured in Q/Epoch. Miners usually don't accept a bid
lower than their advertised ask (which is in q/GiB/Epoch). You can check a miners listed price
with 'shor client query-ask <miner address>'.
