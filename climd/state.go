...
var StateCmd = &cli.Command{
	Name:  "state",
	Usage: "Interact with and query qoin chain state",
	Flags: []cli.Flag{
		&cli.StringFlag{
			Name:  "tipset",
...
func toFil(f types.BigInt) types.QOIN {
	return types.QOIN(f)
}
...
var StateCircSupplyCmd = &cli.Command{
	...
	Usage: "Get the exact current circulating supply of qoin",
	Flags: []cli.Flag{
		&cli.BoolFlag{
			Name:  "vm-supply",
	...
	Action: func(cctx *cli.Context) error {
		...
		if cctx.IsSet("vm-supply") {
			...
			fmt.Println("Circulating supply: ", types.QOIN(circ.FilCirculating))
			fmt.Println("Mined: ", types.QOIN(circ.FilMined))
			fmt.Println("Vested: ", types.QOIN(circ.FilVested))
			fmt.Println("Burnt: ", types.QOIN(circ.FilBurnt))
			fmt.Println("Locked: ", types.QOIN(circ.FilLocked))
		} else {
			...
			fmt.Println("Exact circulating supply: ", types.QOIN(circ))
			return nil
		}
...
var StateSectorCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		fmt.Println("InitialPledge: ", types.QOIN(si.InitialPledge))
		fmt.Println("ExpectedDayReward: ", types.QOIN(si.ExpectedDayReward))
		fmt.Println("ExpectedStoragePledge: ", types.QOIN(si.ExpectedStoragePledge))
		fmt.Println()
...
var stateMarketBalanceCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		fmt.Printf("Escrow: %s\n", types.QOIN(balance.Escrow))
		fmt.Printf("Locked: %s\n", types.QOIN(balance.Locked))
