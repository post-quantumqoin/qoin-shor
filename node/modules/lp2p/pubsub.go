...
import (
	...
	"github.com/post-quantumqoin/qoin-shor/node/modules/tracer"
)
...
func GossipSub(in GossipIn) (service *pubsub.PubSub, err error) {
	...
	pgTopicWeights := map[string]float64{
		...
		// build.BlocksTopic("testnetnet"): 10,
	...
	if in.Cfg.ElasticSearchTracer != "" {
		...
		// tps = addTopicToList(tps, build.BlocksTopic("testnetnet"))
