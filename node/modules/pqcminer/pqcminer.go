...
import (
	...
	"github.com/post-quantumqoin/qoin-shor/miner/pqcminer"
...
func SetupBlockPqcProducer(lc fx.Lifecycle, mctx helpers.MetricsCtx, ds dtypes.MetadataDS, api v1api.FullNode, sf *slashfilter.SlashFilter, j journal.Journal) (*pqcminer.PqcMiner, error) {
	...
	m := pqcminer.NewPqcMiner(api, minerAddr, sf, j)
