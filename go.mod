...
require github.com/post-quantumqoin/go-paddedreader v0.0.0-20260301122305-7167facaaf76
...
require (
	...
	github.com/post-quantumqoin/go-commp-tools/nonffi v0.0.0-20260301130547-d3e4242693b1 // indirect
...
replace github.com/filecoin-project/go-commp-utils => ./lib/go-commp-tools

replace github.com/filecoin-project/go-commp-utils/zerocomm => ./lib/go-commp-tools/zerocomm

replace github.com/filecoin-project/go-commp-utils/ffiwrapper => ./lib/go-commp-tools/ffiwrapper

replace github.com/filecoin-project/go-commp-utils/writer => ./lib/go-commp-tools/writer
...
replace github.com/libp2p/go-libp2p => github.com/libp2p/go-libp2p v0.33.1

replace github.com/quic-go/quic-go => github.com/quic-go/quic-go v0.42.0 // indirect

replace github.com/quic-go/qpack => github.com/quic-go/qpack v0.4.0 // indirect

replace github.com/quic-go/webtransport-go => github.com/quic-go/webtransport-go v0.6.0 // indirect

replace github.com/ipfs/go-block-format => github.com/ipfs/go-block-format v0.2.0

replace github.com/ipld/go-car => github.com/ipld/go-car v0.6.1
