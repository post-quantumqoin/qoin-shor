...
func (e *PqcBase64) UnmarshalJSON(b []byte) error {
	var s string
	if err := json.Unmarshal(b, &s); err != nil {
		return err
	}
...
func (c *QoinCall) UnmarshalJSON(b []byte) error {
	type TempEthCall QoinCall
	var params TempEthCall
...
type QAddress [43]byte

// func (ea QAddress) MarshalJSON() ([]byte, error) {
// 	return json.Marshal(ea.String())
// }

func (ea *QAddress) UnmarshalJSON(b []byte) error {
	var addr string
...
type QoinEstimateGasParams struct {
	Tx       QoinCall
	BlkParam *EthBlockNumberOrHash
}

func (e *QoinEstimateGasParams) UnmarshalJSON(b []byte) error {
	var params []json.RawMessage
	err := json.Unmarshal(b, &params)
	if err != nil {
		return err
...
func (e QoinEstimateGasParams) MarshalJSON() ([]byte, error) {
	if e.BlkParam != nil {
		return json.Marshal([]interface{}{e.Tx, e.BlkParam})
	}
	return json.Marshal([]interface{}{e.Tx})
...
type PqcSignature struct {
	PqcType int       `json:"sigType"`
	Data    PqcBase64 `json:"Data"`
}

type PqcCert struct {
	PqcType   int       `json:"sigType"`
	PublicKey PqcBase64 `json:"publicKey"`
}

// func (e *PqcCert) UnmarshalJSON(b []byte) error {
// 	type TempQoinMessage QoinMessage
// 	var params TempQoinMessage

// 	if err := json.Unmarshal(b, &params); err != nil {
// 		return err
// 	}
// 	fmt.Println("QoinMessage UnmarshalJSON params:", params)
// 	*e = QoinMessage(params)
// 	return nil

// }

type QoinSig struct {
	Cert       []PqcCert      `json:"cert"`
	Signatures []PqcSignature `json:"signatures"`
}

// func (e *QoinSig) UnmarshalJSON(b []byte) error {
// 	var params []json.RawMessage
// 	err := json.Unmarshal(b, &params)
// 	if err != nil {
// 		return err
...
// 	switch len(params) {
// 	case 2:
// 		err = json.Unmarshal(params[1], &e.Signatures)
// 		if err != nil {
// 			return err
// 		}
// 		fallthrough
// 	case 1:
// 		err = json.Unmarshal(params[0], &e.Cert)
// 		if err != nil {
// 			return err
// 		}
// 	default:
...
type QoinMessage struct {
	...
	// gasFeeCap: (0, util_1.bigIntToHex)(this.gasPrice),
	// gasPremium: (0, util_1.bigIntToHex)(this.gasPrice),
	// methodSend: 0,
	// params:Buffer.from([]),

	Verion     int       `json:"verion"`
	To         string    `json:"to"`
	From       string    `json:"from"`
	Nonce      EthBigInt `json:"nonce"`
	Value      EthBigInt `json:"value"`
	GasLimit   EthBigInt `json:"gasLimit"`
	GasFeeCap  EthBigInt `json:"gasFeeCap"`
	GasPremium EthBigInt `json:"gasPremium"`
	MethodSend int       `json:"methodSend"`
	// Params     EthBytes `json:"params"`

	Signatures QoinSig `json:"signatures"`
}

func (m *QoinMessage) UnmarshalJSON(b []byte) error {
	var params []json.RawMessage
	err := json.Unmarshal(b, &params)
	if err != nil {
		return err
	}
	fmt.Println("QoinMessage params:", string(params[0]))

	type TempQoinMessage QoinMessage
	var msg TempQoinMessage

	if err := json.Unmarshal(params[0], &msg); err != nil {
		return err
	}
	*m = QoinMessage(msg)
	// err = json.Unmarshal(params[0], &e)
	// if err != nil {
	// 	return err
	// }
