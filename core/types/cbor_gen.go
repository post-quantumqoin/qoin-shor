...
var lengthBufBlockHeader = []byte{147}
...
func (t *BlockHeader) MarshalCBOR(w io.Writer) error {
	...
	// t.PqcPowProof (types.PqcPowProof) (struct)
	if err := t.PqcPowProof.MarshalCBOR(cw); err != nil {
		return err
	}
	...
	// t.MiningTimestamp (uint64) (uint64)

	if err := cw.WriteMajorTypeHeader(cbg.MajUnsignedInt, uint64(t.MiningTimestamp)); err != nil {
		return err
	}
	...
	*t = BlockHeader{}
	...
	// t.PqcPowProof (types.PqcPowProof) (struct)
	{
		...
		if b != cbg.CborNull[0] {
			...
			t.PqcPowProof = new(PqcPowProof)
			if err := t.PqcPowProof.UnmarshalCBOR(cr); err != nil {
				return xerrors.Errorf("unmarshaling t.PqcPowProof pointer: %w", err)
			}
		}
	...
	// t.MiningTimestamp (uint64) (uint64)
	{
		...
		t.MiningTimestamp = uint64(extra)
...
var lengthBufPqcCertPubkey = []byte{129}

func (t *PqcCertPubkey) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if _, err := cw.Write(lengthBufPqcCertPubkey); err != nil {
		return err
	}

	// t.Typ (string) (string)
	if len(t.Typ) > 8192 {
		return xerrors.Errorf("Value in field t.Falcon512 was too long")
	}
...
func (t *PqcCertPubkey) UnmarshalCBOR(r io.Reader) (err error) {
	*t = PqcCertPubkey{}
...
var lengthBufPQCCert = []byte{132}

func (t *PQCCert) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if _, err := cw.Write(lengthBufPQCCert); err != nil {
		return err
	}

	// t.Pubkeys (types.PqcCertPubkey) ([])
...
func (t *PQCCert) UnmarshalCBOR(r io.Reader) (err error) {
	*t = PQCCert{}
	...
	// t.Pubkeys ([]types.PqcCertPubkey) (slice)
	...
	if extra > 0 {
		t.Pubkeys = make([]PqcCertPubkey, extra)
	}
...
var lengthPowProof = []byte{129}

func (t *PqcPowProof) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if _, err := cw.Write(lengthPowProof); err != nil {
		return err
	}
	// t.Nbit ([]uint8) (slice)
	if len(t.Nbit) > 2097152 {
		return xerrors.Errorf("Byte array in field t.VRFProof was too long")
	}

	if err := cw.WriteMajorTypeHeader(cbg.MajByteString, uint64(len(t.Nbit))); err != nil {
		return err
	}

	if _, err := cw.Write(t.Nbit); err != nil {
		return err
	}

	// t.PowProof ([]uint8) (slice)
	if len(t.PowProof) > 2097152 {
		return xerrors.Errorf("Byte array in field t.VRFProof was too long")
	}

	if err := cw.WriteMajorTypeHeader(cbg.MajByteString, uint64(len(t.PowProof))); err != nil {
		return err
	}

	if _, err := cw.Write(t.PowProof); err != nil {
		return err
	}
...
func (t *PqcPowProof) UnmarshalCBOR(r io.Reader) (err error) {
	*t = PqcPowProof{}
	...
	if extra > 2097152 {
		return fmt.Errorf("t.Nbit: byte array too large (%d)", extra)
	}
	if maj != cbg.MajByteString {
		return fmt.Errorf("expected byte array")
	}
	...
	if extra > 0 {
		t.Nbit = make([]uint8, extra)
	}

	if _, err := io.ReadFull(cr, t.Nbit); err != nil {
		return err
	}
	...
	if extra > 0 {
		t.PowProof = make([]uint8, extra)
	}

	if _, err := io.ReadFull(cr, t.PowProof); err != nil {
		return err
	}
