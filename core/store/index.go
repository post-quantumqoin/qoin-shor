...
import (
	...
	"github.com/post-quantumqoin/qoin-shor/lib/shardedmutex"
)
...
func init() {
	if s := os.Getenv("QOIN_CHAIN_INDEX_CACHE"); s != "" {
		lcic, err := strconv.Atoi(s)
		if err != nil {
			log.Errorf("failed to parse 'QOIN_CHAIN_INDEX_CACHE' env var: %s", err)
		}
